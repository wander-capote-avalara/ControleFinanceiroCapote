				...
				function() {
					CFINAC.usuario.add = function() {
						...
						var msg, username = $("#inputUsernameLogin").val(), email = $(
								...
								"#isActive").val(), familyId = $("#families")
								.val(), id = $("#id").val();
					...
					CFINAC.usuario.exibirFamilias = function(listaDeFamilias) {
						...
						for (var x = 0; x < listaDeFamilias.length; x++) {
							html += "<option value='" + listaDeFamilias[x].id
									+ "'>" + listaDeFamilias[x].name + " - "
									+ listaDeFamilias[x].owner + "</option>";
						}
					...
					CFINAC.usuario.procuraFamilias = function() {
						var cfg = {
							...
							success : function(listaDeFamilias) {
								CFINAC.usuario.exibirFamilias(listaDeFamilias);
							},
							error : function(e) {
								alertPopUp("Erro na ação!")
							}
					...
					CFINAC.usuario.exibirUsuarios = function(listaDeUsuarios,
							valorBusca) {
